        ...
        <footer className="footer">
          ...
          <div className="footer__container">
            ...
            <ul className="footer__socials">
              <li>
                <a aria-label="Facebook" className="footer__social footer__social--facebook" href="#">
              ...
              <li>
                <a aria-label="Twitter" className="footer__social" href="#">
              ...
              <li>
                <a aria-label="Instagram" className="footer__social" href="#">
